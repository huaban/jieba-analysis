...
public class Word implements CharSequence {
    ...
    Word(String token, Double freq, String tokenType) {
        this.token = token;
        this.freq = freq;
     ...
     * <a href="{@docRoot} value specified by the index is a <a
     * href="{@docRoot} value specified by the index is a <a
     * href="{@docRoot} value specified by the index is a <a href="{@docRoot}
     * value specified by the index is a <a href="{@docRoot} value specified by
     * the index is a <a href="{@docRoot} value specified by the index is a <a
     * href="{@docRoot} value specified by the index is a <a href="{@docRoot}
     * value specified by the index is a <a href="{@docRoot} value specified by
     * the index is a <a href="{@docRoot} value specified by the index is a <a
     * href="{@docRoot} value specified by the index is a <a href="{@docRoot}
     ...
     * the index is a <a href="{@docRoot} value specified by the index is a <a
     * href="{@docRoot} value specified by the index is a <a href="{@docRoot}
     * /java/lang/Character.html#unicode">surrogate</a>, the surrogate value is
     * returned.
     *
     * @param index
    ...
    public Word subSequence(int start, int end) {
        return new Word(this.token.substring(start, end), this.freq, this.tokenType);
    }
}
