package org.xm.xmnlp.hanlp.dictionary.py;
...
import org.xm.xmnlp.hanlp.corpus.dictionary.StringDictionary;
...
public class PinyinDictionary {
    ...
    private static boolean saveDat(String path, AhoCorasickDoubleArrayTrie<Pinyin[]> trie, Set<Map.Entry<String, Pinyin[]>> entrySet) {
        try {
