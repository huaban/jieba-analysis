...
public class Viterbi {
    ...
    public static int[] compute(int[] obs, int[] states, double[] start_p, double[][] trans_p, double[][] emit_p) {
        int max_states_value = 0;
        for (int s : states) {
            max_states_value = Math.max(max_states_value, s);
        }
        ++max_states_value;
        double[][] V = new double[obs.length][max_states_value];
        int[][] path = new int[max_states_value][obs.length];
        ...
        for (int t = 1; t < obs.length; ++t) {
            int[][] newpath = new int[max_states_value][obs.length];
