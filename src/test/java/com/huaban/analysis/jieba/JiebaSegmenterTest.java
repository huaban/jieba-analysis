...
public class JiebaSegmenterTest extends TestCase {
  ...
  String[] sentences =
      new String[] {
          ...
          "供大家参考指正", "哈尔滨政府公布塌桥原因", "我在机场入口处", "邢永臣摄影报道", "BP神经网络如何训练才能在分类时增加区分度？", "南京市长江大桥",
          "应一些使用者的建议，也为了便于利用NiuTrans用于SMT研究", "长春市长春药店", "邓颖超生前最喜欢的衣服", "胡锦涛是热爱世界和平的政治局常委",
  ...
  public void testSegmentSpeed() {
    ...
    System.out.println(String
        .format("time elapsed:%d, rate:%fkb/s, words:%.2f/s", elapsed, (length * 1.0) / 1024.0f
            / (elapsed * 1.0 / 1000.0f), wordCount * 1000.0f / (elapsed * 1.0)));
  }
}
